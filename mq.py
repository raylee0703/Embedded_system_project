...
class MQ():
    ...
    RO_CLEAN_AIR_FACTOR          = 3.5     # RO_CLEAR_AIR_FACTOR=(Sensor resistance in clean air)/RO,
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.adc = MCP3008()
        '''
        self.CO2Curve = [1,0.34,-0.31]    # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent"
                                            # to the original curve. 
                                            # data format:{ x, y, slope}; point1: (lg200, 0.21), point2: (lg10000, -0.59) 
        self.COCurve = [1,0.45,-0.27]     # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg200, 0.72), point2: (lg10000,  0.15)
        self.ALCOHOLCurve =[1,0.26,-0.29]   # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg200, 0.53), point2: (lg10000,  -0.22)  
        '''
        self.CO2Curve = [2,0.02,-0.39]
        self.COCurve = [2,0.23,-0.28]
        self.ALCOHOLCurve = [2,-0.04,-0.34]        
        print("Calibrating...")
